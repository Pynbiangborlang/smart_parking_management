...
FOR EACH ROW
WHEN (NEW.READING =0) -- INCOMING DATA AND OLD DATA NEEDS TOBE DIFFERENT 0 INDICATES CHECKIN 
...
DROP TRIGGER CHECK_OUT ON PARKING_SENSOR_READING;
...
DROP TRIGGER IF EXISTS DEDUCT_FROM_WALLET ON BILL;
