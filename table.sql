...
DROP TABLE IF EXISTS PARKING_SPACE CASCADE;
...
DROP TABLE IF EXISTS PARKING_SENSOR CASCADE;
...
DROP TABLE IF EXISTS PARKING_SENSOR_READING CASCADE;
...
DROP TABLE IF EXISTS GATE_SENSOR_READING CASCADE;
...
DROP TABLE IF EXISTS USER_PARKING_HISTORY CASCADE;
...
DROP TABLE IF EXISTS USER_WALLET_HISTORY CASCADE;
